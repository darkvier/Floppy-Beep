...
public class EntityFactory {
     ...
     *
     * @param world    world
     * @param position vector con la posicion inicial (metros)
     */
    public PlayerEntity createPlayer(World world, MainGame game, Vector2 position) {
        return new PlayerEntity(world, game, position);
    }
    ...
    public Object[] createMuros(World world, float x, float t, float apertura, List<MuroEntity> muroList, Stage stage) {
        ...
        float heightSup = stageHeight - ySup + PIXELS_IN_METER; //Fix para que los muros lleguen al techo
